...
def infotodict(seqinfo):
    ...
    nback_PA = create_key('sub-{subject}/func/sub-{subject}_task-nback_run-{item:02d}_bold_acq-PA')
    nback_PA_sbref = create_key('sub-{subject}/func/sub-{subject}_task-nback_run-{item:02d}_sbref_acq-PA')

    nback_AP = create_key('sub-{subject}/func/sub-{subject}_task-nback_run-{item:02d}_bold_acq-AP')
    nback_AP_sbref = create_key('sub-{subject}/func/sub-{subject}_task-nback_run-{item:02d}_sbref_acq-AP')
